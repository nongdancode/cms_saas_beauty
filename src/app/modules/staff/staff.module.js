(function(){
  const module = angular.module('module.staff', [
    ...
    'module.staff.containers.shift-management-summary',
  ...
  module.config(function($stateProvider) {
    $stateProvider
      ...
      .state('shift-management-timeline', {
        parent: 'ng-admin',
	      url: '/staff/shift-timeline',
	      template: '<shift-management-summary $resolve="$resolve"></shift-management-summary>',
        resolve: {
          shifts: function($stateParams, StaffService) {
            return StaffService.getAllShifts();
          },
